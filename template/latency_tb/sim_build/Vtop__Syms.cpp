    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_TOP.varInsert(__Vfinal,"cycle_count", &(TOP.cycle_count), false, VLVT_WDATA,VLVD_OUT|VLVF_PUB_RW,1 ,255,0);
        ...
        __Vscope_top.varInsert(__Vfinal,"cycle_count", &(TOP.top__DOT__cycle_count), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1 ,255,0);
